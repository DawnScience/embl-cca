...
public class PointWithValueIID extends Point implements Serializable, Comparable<PointWithValueIID> {
		
	/**
	 * 
	 */
	private static final long serialVersionUID = -5632956254610942296L;
	 ...
	 */
	public PointWithValueIID( int x, int y, double z ) {
		super( x, y );
		this.z = z;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PointWithValueIID)) return false;
		PointWithValueIID p = (PointWithValueIID)object;
	...
	@Override
	public int compareTo(PointWithValueIID o) {
