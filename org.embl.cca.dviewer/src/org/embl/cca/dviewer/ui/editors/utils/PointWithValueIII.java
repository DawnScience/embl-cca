 ...
 * and the z coordinate is type of int. In this class the
...
public class PointWithValueIII extends Point implements Serializable, Comparable<PointWithValueIII> {
		
	/**
	 * 
	 */
	private static final long serialVersionUID = 838033461480606093L;
	 ...
	 */
	public PointWithValueIII( int x, int y, int z ) {
		super( x, y );
		this.z = z;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PointWithValueIII)) return false;
		PointWithValueIII p = (PointWithValueIII)object;
	...
	@Override
	public int compareTo(PointWithValueIII o) {
