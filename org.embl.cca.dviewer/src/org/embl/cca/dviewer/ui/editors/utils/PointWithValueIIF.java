 ...
 * and the z coordinate is type of float. In this class the
...
public class PointWithValueIIF extends Point implements Serializable, Comparable<PointWithValueIIF> {
		
	/**
	 * 
	 */
	private static final long serialVersionUID = -6151623391782101814L;
	 ...
	 */
	public PointWithValueIIF( int x, int y, float z ) {
		super( x, y );
		this.z = z;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PointWithValueIIF)) return false;
		PointWithValueIIF p = (PointWithValueIIF)object;
	...
	@Override
	public int compareTo(PointWithValueIIF o) {
