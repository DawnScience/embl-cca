 ...
 * and the z coordinate is type of short. In this class the
...
public class PointWithValueIIS extends Point implements Serializable, Comparable<PointWithValueIIS> {
		
	/**
	 * 
	 */
	private static final long serialVersionUID = 7706675734993150520L;
	 ...
	 */
	public PointWithValueIIS( int x, int y, short z ) {
		super( x, y );
		this.z = z;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PointWithValueIIS)) return false;
		PointWithValueIIS p = (PointWithValueIIS)object;
	...
	@Override
	public int compareTo(PointWithValueIIS o) {
