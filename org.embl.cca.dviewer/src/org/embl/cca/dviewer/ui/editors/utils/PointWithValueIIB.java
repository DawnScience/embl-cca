 ...
 * and the z coordinate is type of byte. In this class the
...
public class PointWithValueIIB extends Point implements Serializable, Comparable<PointWithValueIIB> {
		
	/**
	 * 
	 */
	private static final long serialVersionUID = 4875124837381636219L;
	 ...
	 */
	public PointWithValueIIB( int x, int y, byte z ) {
		super( x, y );
		this.z = z;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PointWithValueIIB)) return false;
		PointWithValueIIB p = (PointWithValueIIB)object;
	...
	@Override
	public int compareTo(PointWithValueIIB o) {
